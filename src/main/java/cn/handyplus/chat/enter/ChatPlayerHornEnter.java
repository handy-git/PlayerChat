...
public class ChatPlayerHornEnter {
    ...
    @TableField(value = "player_uuid", comment = "玩家uuid", notNull = true, indexEnum = IndexEnum.UNIQUE, uniqueGroup = "player_horn")
    private UUID playerUuid;

    @TableField(value = "type", comment = "类型", notNull = true, indexEnum = IndexEnum.UNIQUE, uniqueGroup = "player_horn")
    private String type;
